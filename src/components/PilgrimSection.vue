        ...
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="flex flex-col lg:flex-row items-start gap-8 lg:gap-16">
                ...
                <div class="lg:w-1/2 relative">
                    <div
                        class="absolute -right-4 -bottom-4 w-full h-full border-2 border-yellow-600 dark:border-yellow-700 rounded-lg">
                    </div>
                    <div class="absolute inset-0 bg-gradient-to-t from-yellow-700/20 to-transparent rounded-lg"></div>
                    <img src="../assets/marche_marie.jpg" alt="Pèlerinage de Poponguine"
                        class="h-auto w-full object-cover rounded-lg shadow-lg relative z-10 position-bottom" />
                    <!-- Optional decorative elements -->
                    <div
                        class="absolute -left-6 -top-6 w-16 h-16 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center z-50">
                        <svg height="30" width="30" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            xml:space="preserve" class="fill-yellow-700 dark:fill-yellow-500">
                            <circle cx="295.608" cy="86.351" r="6.776" />
                            <circle cx="335.617" cy="86.351" r="6.776" />
                            <path
                                d="M334.51,102.209c-3.229-2.781-8.102-2.417-10.881,0.814c-0.801,0.931-3.687,2.408-8.018,2.408
               ...
               c11.345,0,20.575,9.23,20.575,20.575C447.327,217.937,438.097,227.167,426.752,227.167z" />
                ...
                <!-- Text content -->
                <div class="lg:w-1/2">
                    <h2 class="text-3xl md:text-4xl font-serif font-semibold mb-6 text-stone-800 dark:text-stone-200">
                        Pèlerinage Marial de Poponguine
                    </h2>

                    <div class="prose prose-stone dark:prose-invert max-w-none">
                        <p class="mb-4 text-stone-700 dark:text-stone-300 font-serif text-lg leading-relaxed">
                            Cette plateforme a été spécialement conçue pour accompagner les pèlerins dans leur
                            préparation au <strong class="text-yellow-700 dark:text-yellow-500">137ème pèlerinage marial
                                de Poponguine</strong>, qui se tiendra du <strong
                                class="text-yellow-700 dark:text-yellow-500">7 au 9 juin 2025</strong>. Elle vise à
                            simplifier l'organisation, l'inscription et la participation à cet événement spirituel
                            unique.
                        </p>

                        <p class="mb-4 text-stone-700 dark:text-stone-300 font-serif text-lg leading-relaxed">
                            En tant que pèlerin, vous pourrez accéder à toutes les informations nécessaires, vous
                            inscrire facilement, et suivre les actualités en temps réel. Que vous soyez un habitué ou un
                            nouveau participant, notre objectif est de rendre votre expérience aussi fluide et
                            enrichissante que possible.
                        </p>

                        <p class="text-stone-700 dark:text-stone-300 font-serif text-lg leading-relaxed">
                            Le pèlerinage marial de Poponguine est l'occasion de vivre un moment de communion
                            fraternelle, de prière et de recueillement auprès de Notre-Dame de la Délivrande. Rejoignez
                            des milliers de fidèles dans cette démarche de foi et de dévotion mariale qui rassemble
                            chaque année la communauté catholique du Sénégal et d'ailleurs.
                        </p>
                    </div>
                    ...
                    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div
                            class="p-4 bg-white dark:bg-stone-800 rounded-lg border border-stone-200 dark:border-stone-700 shadow-sm">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 p-2 bg-yellow-100 dark:bg-yellow-900/30 rounded-full mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-5 w-5 text-yellow-700 dark:text-yellow-500" fill="none"
                                ...
                                <div>
                                    <h3 class="text-md font-semibold text-stone-800 dark:text-stone-200 font-serif">
                                        Dates</h3>
                                    <p class="text-stone-600 dark:text-stone-400">7 au 9 juin 2025</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h3 class="text-md font-semibold text-stone-800 dark:text-stone-200 font-serif">Départ
                                    </h3>
                                    <p class="text-stone-600 dark:text-stone-400">Cap de Biches</p>
                                </div>
                            </div>
                        </div>
                    </div>
